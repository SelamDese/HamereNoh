...
namespace HamereNoh.Controllers
{
    public class BatchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BatchId,BatchName,ProgramId")] Batch batch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BatchId,BatchName,ProgramId")] Batch batch)
        {
            if (id != batch.BatchId)
            {
                return NotFound();
